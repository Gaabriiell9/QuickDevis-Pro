  ...
  return (
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <EmptyState icon={Receipt} title="Aucune facture" description="Créez votre première facture." action={<Button asChild><Link href="/invoices/new">Créer une facture</Link></Button>} />
      ) : (
        <>
          <Table>
            <TableHeader>
