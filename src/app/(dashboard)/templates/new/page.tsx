          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="space-y-2"><Label>Texte footer</Label><Input value={config.footerText ?? ""} onChange={e => updateConfig({ footerText: e.target.value })} placeholder="Ex: Merci de votre confiance" /></div>
              </CardContent>
            </Card>
