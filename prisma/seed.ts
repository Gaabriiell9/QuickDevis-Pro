...
async function main() {
  ...
  // No pre-seeded templates — utilisateurs créent les leurs (plan PRO)
  // Le rendu par défaut est le layout Abby avec couleur indigo (#4338CA)
  console.log("✅ Templates: aucun template pré-défini (layout Abby par défaut)");
